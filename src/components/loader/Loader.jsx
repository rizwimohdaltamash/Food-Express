...
const Loader = () => {
  return (
    <div
      role="status"
      className="fixed inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-orange-50 via-yellow-50 to-red-50 z-50"
    >
      <svg
        aria-hidden="true"
        className="w-16 h-16 animate-spin text-orange-300 fill-orange-600"
        viewBox="0 0 100 101"
        fill="none"
      ...
      <p className="mt-4 text-orange-600 font-semibold text-lg animate-pulse flex items-center gap-2">
        Preparing your order... <UtensilsCrossed className="w-5 h-5" />
      </p>
    </div>
  );
};
